...
function attachMarkerToCountry( countryName, importance ){
	...
	if(country.exportedAmount > 0 && country.importedAmount > 0) {
	   importExportText += "importado:&nbsp;US$" + numberWithCommas(country.importedAmount) + "<br />" +
	       "exportado:&nbsp;US$"+numberWithCommas(country.exportedAmount);
	} else if(country.exportedAmount > 0 && country.importedAmount == 0) {
	   importExportText += "exportado:&nbsp;US$"+numberWithCommas(country.exportedAmount)+"<br />&nbsp;";
	} else if(country.exportedAmount == 0 && country.importedAmount > 0) {
	   importExportText += "importado:&nbsp;US$"+numberWithCommas(country.importedAmount)+"<br />&nbsp;";
	}

...
var isoFile = 'country_iso3166_es_new.json';
...
var exportColor = 0xff0000;
var importColor = 0x0000ff;
...
function initScene() {
	...
	selectVisualization(timeBins, '2010', ['PERÚ'], ['Military Weapons'], ['Military Weapons']);
	...
	if(is_mobile){
		...
		highlightCountry(["PERÚ", "ECUADOR", "BOLIVIA", "BRASIL", "COLOMBIA"]);
